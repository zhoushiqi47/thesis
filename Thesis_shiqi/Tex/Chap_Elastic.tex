...
令 $\ep_0=\min(\frac{\phi^*-\phi_\kappa}{2},\frac{\phi_\kappa}{2})>0$. Obviously, $t_1-\ep_0\le -\pi/2, t_1+\ep_0\le -(\phi^*-\phi_\kappa)/2$ and $t_2-\ep_0\ge(\phi^*-\phi_\kappa)/2$. We divide $(-\pi/2,\pi/2)$ into five intervals:
